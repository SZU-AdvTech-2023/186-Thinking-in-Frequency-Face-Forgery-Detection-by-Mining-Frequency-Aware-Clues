...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='xecption', help='architecture for binary classification')
        ...
        parser.add_argument('--loadSize', type=int, default=333, help='scale images to this size')
        parser.add_argument('--cropSize', type=int, default=299, help='then crop to this size')
        ...
        # parser.add_argument('--elevation', default=False, help='used improved method ?')
